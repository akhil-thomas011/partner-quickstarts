Param(
    [string] [Parameter(Mandatory=$true)] $subscriptionName,		# Name of the Azure subscription
    [string] [Parameter(Mandatory=$true)] $cloudwiseAppServiceURL,	# This is the Unique URL of the Cloudwise App Service deployed by the ARM script
    [string] [Parameter(Mandatory=$true)] $passwordADApp 		    # This is the password for the new AD Application
)
...
# 1) Ensure you pass the right subscription name in the parameter $subscriptionName
